    ...
    <header>
        ...
        <div class="productes_principal2">
            ...
            <div class="informacio_producte">
                <img class="imatge_producte" src="<?php echo $single["img"] ?>" alt="<?php echo $single["nom_prod"] ?>">
                ...
                foreach ($singles2 as $single2) :  ?>
                    ...
                    <a href="producte.php?id=<?php echo $single2["id"] ?>">
                        <div class="informacio_producte_semblant">
                            <img class="imatge_producte_semblant" src="<?php echo $single2["img"] ?>" alt="<?php echo $single["nom_prod"] ?>">
                            <div class="informacio_producte2">
        ...
        <footer>
            ...
            <div class="slideshow-container">
                ...
                <div class="mySlides_fade">
                    ...
                    <img src="img/img_logo/brico2.jpg" alt="brico1">

                </div>

                <div class="mySlides_fade">

                    <img src="img/img_logo/brico3.jpg" alt="brico2">
